...
import 'form_shop_page_model.dart';
export 'form_shop_page_model.dart';

class FormShopPageWidget extends StatefulWidget {
  const FormShopPageWidget({super.key});

  @override
  State<FormShopPageWidget> createState() => _FormShopPageWidgetState();
}

class _FormShopPageWidgetState extends State<FormShopPageWidget> {
  late FormShopPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormShopPageModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              wrapWithModel(
                model: _model.backgroundPrimaryViewModel,
                updateCallback: () => setState(() {}),
                child: BackgroundPrimaryViewWidget(),
              ),
                                      ...
                                      Expanded(
                                        child: Wrap(
                                          ...
                                          children: [
                                            ...
                                            if (_model.imageTmpList.length < 3)
                                              InkWell(
